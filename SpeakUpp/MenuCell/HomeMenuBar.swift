...
class HomeMenuBar: BaseUIView {
    ...
    let labels = [HomeMenuLabel(title: "Home",image: "TabHome"),HomeMenuLabel(title: "Event",image: "TabEvent"),HomeMenuLabel(title: "Me",image: "TabProfile"),HomeMenuLabel(title: "Quiz",image: "TabTrending")]
